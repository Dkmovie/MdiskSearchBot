...
async def help_handler(_, event: Message):
    ...
    await event.reply_text(Config.ABOUT_HELP_TEXT.format(event.from_user.mention),
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("Our Channel", url="https://t.me/DK_Gru"),
             InlineKeyboardButton("Our Group", url="https://t.me/DK_HDmovie"), 
             InlineKeyboardButton("About", callback_data="About_msg")]
        ])
    )
        ...
        if "About_msg" in cb_data:
				...
				[
					[
						...
						InlineKeyboardButton("Our Channel", url="https://t.me/DK_Gru")
                                        ...
                                        [
						InlineKeyboardButton("Owner", url="https://t.me/DK_Gru"),
						InlineKeyboardButton("Home", callback_data="gohome")
					]
				]
			),
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
						InlineKeyboardButton("Support", url="https://t.me/DK_HDmovie"),
						InlineKeyboardButton("Channel", url="https://t.me/DK_Area")
					]
				]
			),
			parse_mode="html"
